    ...
    <Popup appearFrom="center" isOpen={isOpen} onClose={onClose} className={styles.modal}>
      <div className={styles.container}>
        ...
        <div className={styles.transactionInfoWrapper}>
          ...
          <div className={cn(styles.infoItem, styles.managerComment)}>
            <span className={styles.subTitle}>
              <FormattedMessage id="" defaultMessage="Коментарий менеджера" />
            </span>
            <span className={styles.info}>
        ...
        <div className={styles.buttonsWrapper}>
          <Button onClick={() => console.log(1)}>
            <FormattedMessage id="" defaultMessage="Повторить перевод" />
          </Button>
        </div>
      </div>
    </Popup>
